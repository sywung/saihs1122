...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/1.png" alt="image" width="auto" height="180"></td>
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/2.png" alt="image" width="auto" height="120"></td>
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/3.png" alt="image" width="auto" height="220"></td>
  </tr></table></div>
...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/4.jpeg" alt="image" width="auto" height="180"></td>
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/5.jpg" alt="image" width="auto" height="180"></td>
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/6.jpg" alt="image" width="auto" height="180"></td>
  </tr></table></div>
