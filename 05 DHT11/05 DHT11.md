...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/clip_image002.png" alt="image" width="auto" height="200"></td>
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/clip_image004.png" alt="image" width="auto" height="200"></td>
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/clip_image006.png" alt="image" width="auto" height="200"></td>
  </tr></table></div>
...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/clip_image007.png" alt="image" width="auto" height="300"></td>
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/clip_image009.png" alt="image" width="auto" height="300"></td>
  </tr></table></div>
