...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/clip_image001.jpg" alt="image" width="auto" height="240"></td>
    <td style="width: 30%; border: none; padding: 5px;"><img src="assets/clip_image003.png" alt="image" width="auto" height="240"></td>
...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 40%; border: none; padding: 5px;"><img src="assets/clip_image006.png" alt="image" width="auto" height="240"></td><td></td>
    <td style="width: 40%; border: none; padding: 5px;"><img src="assets/clip_image007.jpg" alt="image" width="auto" height="240"></td>
  </tr></table></div>
